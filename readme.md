...
- If you want to persist a base256 archive to disk remember to use the "latin1" encoding, otherwise the file on disk may weigh significantly more than necessary.
